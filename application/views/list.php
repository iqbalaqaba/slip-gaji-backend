<html>
  ...
  <body>
      <center>
        ...
        <a href="<?php echo base_url()?>index/tambah"> Tambah data</a>
        <?php endif; ?>
    ...
    <tr>
     <td><?php echo $no++ ?></td>
      ...
      <td> <?php echo anchor('dashboard/index/edit_gaji/'.$row->id_user,'edit gaji'); ?>
        <?php echo anchor('dashboard/index/hapus_user/'.$row->id_user,'hapus user'); ?>
       </td>
    </tr>
    <?php } ?>
  </table>
